...
class EncounterTable extends Table
  ...
  List<GeneratedColumn> get $columns =>
      [id, name, type, combatants, engine, round, turn, logs, syncId];
  @override
...
class CustomBestiaries extends Table
    with TableInfo<CustomBestiaries, CustomBestiariesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  CustomBestiaries(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
      hasAutoIncrement: true,
      type: DriftSqlType.int,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  CustomBestiariesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return CustomBestiariesData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      name: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}name'])!,
  ...
  @override
  CustomBestiaries createAlias(String alias) {
    return CustomBestiaries(attachedDatabase, alias);
  }
}

class CustomBestiariesData extends DataClass
    implements Insertable<CustomBestiariesData> {
  final int id;
  final String name;
  final String combatants;
  final int engine;
  const CustomBestiariesData(
      {required this.id,
      required this.name,
      required this.combatants,
      required this.engine});
  ...
  factory CustomBestiariesData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return CustomBestiariesData(
      id: serializer.fromJson<int>(json['id']),
  ...
  CustomBestiariesData copyWith(
          {int? id, String? name, String? combatants, int? engine}) =>
      CustomBestiariesData(
        id: id ?? this.id,
        name: name ?? this.name,
        combatants: combatants ?? this.combatants,
        engine: engine ?? this.engine,
      );
  CustomBestiariesData copyWithCompanion(CustomBestiariesCompanion data) {
    return CustomBestiariesData(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
      combatants:
  ...
  @override
  String toString() {
    return (StringBuffer('CustomBestiariesData(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('combatants: $combatants, ')
          ..write('engine: $engine')
...
class CustomBestiariesCompanion extends UpdateCompanion<CustomBestiariesData> {
  final Value<int> id;
  final Value<String> name;
  final Value<String> combatants;
  final Value<int> engine;
  ...
  CustomBestiariesCompanion.insert({
    ...
    required int engine,
        ...
        combatants = Value(combatants),
        engine = Value(engine);
  static Insertable<CustomBestiariesData> custom({
    Expression<int>? id,
    Expression<String>? name,
    Expression<String>? combatants,
    Expression<int>? engine,
...
class DatabaseAtV5 extends GeneratedDatabase {
  ...
  late final CustomBestiaries customBestiaries = CustomBestiaries(this);
  @override
